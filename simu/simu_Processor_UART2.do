vlib work
vcom -2008 ../src/Processor_UART2.vhd
...
vcom -2008 ../src/Instructions_Unit_UART2.vhd
vcom -2008 ../src/instruction_memory_UART2.vhd
vcom -2008 ../src/PC_update_unit_VIC.vhd
vcom -2008 ../src/PC_reg.vhd
vcom -2008 Processor_UART2_TB.vhd

vsim work.PROCESSOR_UART2_TB
